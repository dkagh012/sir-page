...
<!-- <div class="index_menu">
	<ul class="shortcut">
        <li><a href="<?php echo G5_BBS_URL ?>/faq.php"><i class="fa fa-question-circle"></i> Q&A</a></li>
        <li><a href="<?php echo G5_BBS_URL ?>/qalist.php"><i class="fa fa-comments"></i> FAQ</a></li>
